...
class DatabaseManager:
    ...
    def get_variant_id(self, variant_name: str, database_name: str) -> Optional[int]:
        ...
        Returns:
            Optional[int]: The idVariant if found, else None.
        """
    ...
    def save_image(self, database_name: str, id_variant: int, image_path: str, image_type: int) -> None:
        ...
        Parameters:
            database_name (str): The target database name.
            id_variant (int): The id of the variant associated with the image.
            image_path (str): The path to the image file to save.
            image_type (int): 1 for pre-image, 2 for post-image.

        Raises:
            ValueError: If image_type is invalid.
            FileNotFoundError: If the image file does not exist.
        """
        # Validate image type and select the corresponding table and column
...
class CognexManager:
    ...
    def capture_image(self, job_name: str, output_path: str) -> None:
        ...
        Parameters:
            job_name (str): The job to load on the Cognex system.
    ...
    def __del__(self):
        """
        Ensure the Cognex system is properly disconnected on object destruction.
        """
        try:
...
def retry_operation(operation, retries: int = 3, *args, **kwargs):
    ...
    Parameters:
        operation (callable): The function to retry.
